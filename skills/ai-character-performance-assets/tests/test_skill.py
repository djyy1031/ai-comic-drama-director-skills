...
def valid_payload():
    return {
        ...
        "语言单元": [{
            ...
            "逐句表演": {"情绪":"压住怒意", "对象与目的":"向李四质问以确认隐瞒", "语气":"克制而强硬", "身体配合":"放下账本并盯住李四"},
            "建议片段": [
                {"片段顺序": 1, "原文片段": "你为什么", "开始方式": "动作触发开始", "开始触发": "张三放下账本后", "声音状态": "压住怒意开始质问", "表演承接":"起始压住怒意，放下账本注视李四，强硬质问"},
                {"片段顺序": 2, "原文片段": "骗我？", "开始方式": "无停顿承接", "开始触发": "切到李四反应镜头时", "声音状态": "同一口气加重句尾", "表演承接":"继承怒意、质问目的与注视，强调骗我，不重启动作"},
            ],
        }],
        "表演节拍": [
