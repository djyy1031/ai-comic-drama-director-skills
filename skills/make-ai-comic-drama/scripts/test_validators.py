...
def fixture() -> dict:
    ...
    return {
        ...
        "model_profile": {"model": "已验证模型", "version": "v1", "segment_max_seconds": 10.0, "max_shots_per_segment": 1, "supports_multi_shot": False, "identity_reference_limit": 2, "scene_reference_limit": 1},
        "entities": {
        ...
        "shots": [{"shot_id": "SH-001", "scene_id": "SC-001", "timeline_in": 0.0, "timeline_out": 10.0, "duration": 10.0, "character_ids": ["CHR-001"], "location_id": "LOC-001", "prop_ids": ["PROP-001"], "costume_ids": ["CST-001"], "reference_ids": ["REF-001"], "start_state": copy.deepcopy(state), "end_state": copy.deepcopy(state)}],
        "segments": [{"segment_id": "SEG-001", "shot_ids": ["SH-001"], "duration": 10.0, "character_reference_ids": ["REF-001"], "scene_reference_ids": ["REF-001"], "fallback": "动作简化"}],
    }
...
class ValidatorTests(unittest.TestCase):
    ...
    def test_model_limit(self) -> None:
        data = fixture(); second = copy.deepcopy(data["shots"][0]); second["shot_id"] = "SH-002"
        data["shots"].append(second); data["segments"][0]["shot_ids"].append("SH-002")
